...
export class AttachmentWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  @WorkspaceRelation({
    standardId: ATTACHMENT_STANDARD_FIELD_IDS.contact,
    type: RelationType.MANY_TO_ONE,
    label: msg`Contact`,
    description: msg`Attachment contact`,
    icon: 'IconUser',
  ...
  @WorkspaceRelation({
    standardId: ATTACHMENT_STANDARD_FIELD_IDS.call,
    type: RelationType.MANY_TO_ONE,
    label: msg`Call`,
    description: msg`Attachment call`,
    icon: 'IconPhone',
