...
import {
    CALL_DATA_SEED_COLUMNS,
    CALL_DATA_SEEDS,
} from 'src/engine/workspace-manager/dev-seeder/data/constants/call-data-seeds.constant';
import {
...
import {
    CONTACT_DATA_SEED_COLUMNS,
    CONTACT_DATA_SEEDS,
} from 'src/engine/workspace-manager/dev-seeder/data/constants/contact-data-seeds.constant';
import {
...
import {
    LEAD_DATA_SEED_COLUMNS,
    LEAD_DATA_SEEDS,
} from 'src/engine/workspace-manager/dev-seeder/data/constants/lead-data-seeds.constant';
import {
...
const getRecordSeedsConfigs = (
  ...
  {
    tableName: 'contact',
    pgColumns: CONTACT_DATA_SEED_COLUMNS,
    recordSeeds: CONTACT_DATA_SEEDS,
  },
  ...
  {
    tableName: 'lead',
    pgColumns: LEAD_DATA_SEED_COLUMNS,
    recordSeeds: LEAD_DATA_SEEDS,
  },
  {
    tableName: 'call',
    pgColumns: CALL_DATA_SEED_COLUMNS,
    recordSeeds: CALL_DATA_SEEDS,
  },
];
